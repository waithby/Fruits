<template>
	<div id="box">
		<header class="mui-bar mui-bar-nav index-nav" id="header">
			<a href="#" class="index-posit">广州<span class="mui-icon mui-icon-arrowdown"></span></a>
		...
		<div class="mui-content index-body clear">
			<div class="zhezhao">
				<ul class="list_city">
					<li>北京</li>
					<li>上海</li>
			...
			<div class="index_time">
				<div class="index_time_p1">限时抢购</div>
				<div class="index_time_p2">剩余
			...
			<div class="index_user_center clear">
				...
				<div class="index_u_t1">签到赚积分</div>
				<div class="index_u_t1">账户充值</div>
			</div>
			<!--index_user_center-->
			<div class="index_user_center clear">
		...
		<div class="footer">
			<nav class="mui-bar-tab">
				<a class="mui-tab-item mui-active">
					...
					<span class="mui-tab-label" @click="goodsajax()">首页</span>
				</a>
				<a class="mui-tab-item">
					<span class="mui-icon iconfont icon-orderlist"></span>
					<span class="mui-tab-label">分页</span>
				</a>
				<a class="mui-tab-item">
					<span class="mui-icon iconfont icon-fenxiang"></span>
					<span class="mui-tab-label">分享购</span>
				</a>
				<a class="mui-tab-item">
					<span class="mui-icon iconfont icon-caigou-xianxing"></span>
					<span class="mui-tab-label">购物车</span>
				</a>
				<a class="mui-tab-item">
					<span class="mui-icon iconfont icon-yonghu-xianxing"></span>
...
<script type="text/javascript">
	...
	import timer from "./components/main/js/timer.js";
	import zhezhao from "./components/main/js/zhezhao.js";
//	import goods from "./components/main/js/goods.js";
	export default {
		data: function() {
			return {
				dfg: 'dfg',
		...
		methods: {
			...mapActions(["goodsajax"], ["zhezhao"]),
			goodsajax() {
				try {
					this.$store.dispatch("correctNum",1);
				} catch(error) {
					alert(error)
				}
			},
